...
BERT_PATH = "/home/seb/Documents/Deep_learning/NLP/BERT/Fine_tunning_Bert_for_sentences_classification/bert_base_uncased/"#path to your pre trained BERT model
MODEL_PATH = "/home/seb/Documents/Deep_learning/NLP/BERT/Fine_tunning_Bert_for_sentences_classification/model.bin"#path to were your pre trained model will be saved 
			#: it should be outside of your folders, at the same level as input src and predictions
DATA_FILE = "/home/seb/Documents/Deep_learning/NLP/BERT/Fine_tunning_Bert_for_sentences_classification/input/train_val.csv"#path to your train_val csv : it should be in your input directory
...
PARAM_OPTI = "/home/seb/Documents/Deep_learning/NLP/BERT/Fine_tunning_Bert_for_sentences_classification/input/to_optimize.txt"
# A text file in which each line corresponds to the name of the layer that you would like to optimize (layers that you don't want frozen).
# If file empty then all layers, that also means BERT layers, will be optimized.
PARAM_DECAY = "/home/seb/Documents/Deep_learning/NLP/BERT/Fine_tunning_Bert_for_sentences_classification/input/no_decay.txt"
# A text file in which each line corresponds to the a key word referring to groups layer, or a single layer if you right the full name of the layer,
